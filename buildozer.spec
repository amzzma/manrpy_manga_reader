...
source.include_exts = py,png,jpg,kv,atlas,ttf,json,txt,java,class
...
requirements = python3, kivy==master, https://github.com/kivymd/KivyMD/archive/master.zip, PIL, pdfminer.six, charset_normalizer==2.1.1, cryptography, cffi, pycparser
...
presplash.filename = %(source.dir)s/cover/000.png

# (str) Icon of the application
icon.filename = %(source.dir)s/cover/icon.png
...
android.permissions = android.permission.INTE,RNET,android.permission.WRITE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE,android.permission.MANAGE_EXTERNAL_STORAGE
# android.permissions = android.permission.INTE,RNET, android.READ_EXTERNAL_STORAGE, Wandroid.RITE_EXTERNAL_STORAGE, android.MANAGE_EXTERNAL_STORAGE
#,android.add_src, android.add_jars, android.add_aars
...
# OUYA-ODK/libs/*.jar
android.add_jars = java/org/open/marpy/commons-io-2.15.0.jar
...
android.add_activities = org.test.myapp.FolderCopyExample
...
#p4a.source_dir = /home/amz/work/python-for-android-develop
